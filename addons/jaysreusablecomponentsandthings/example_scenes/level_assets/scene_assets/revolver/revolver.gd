...
func _shared_between_primary_and_alternate(gun_range: float, anim_speed: float) -> void:
	...
	var hit: Dictionary = RaycastIt.ray_from_camera_3d(gun_range, get_viewport().get_camera_3d(), true, 0.1, [get_parent_node_3d().owner])
	if (hit != {}):
